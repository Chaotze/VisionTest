...
VisionTest 是一个结合人机交互设计与计算机视觉能力的智能视力筛查应用，面向学生、办公人群和家庭用户。它希望利用普通硬件条件完成更方便的日常视力监测：一块电脑屏幕，加上一枚摄像头即可开始使用。

项目的核心思路，是把传统的 E 字视力表转化为交互式数字体验。它不再依赖固定纸质视力表和固定测试距离，而是通过屏幕 PPI 校准、基于摄像头的人脸测距，以及实时视标尺寸计算，让测试流程更灵活，也更贴近日常居家和办公环境。
...
VisionTest 由 VisionTest 项目团队 / Chaotze 维护。

## 开源许可

当前仓库附带的许可证为 GNU Affero General Public License v3.0，详见 [LICENSE](./LICENSE)。

## 致谢

- GitHub 官方关于 README 内容组织与仓库展示的文档建议
